...
//
//*****************************************************************************
static void WriteData(unsigned char ucData)
{
    //
...
//
//*****************************************************************************
static void WriteCommand(unsigned char ucData)
{
    //
...
//
//*****************************************************************************
static void Formike128x128x16Flush(void *pvDisplayData)
{
    //
...
//*****************************************************************************
static void
Formike128x128x16LineDrawH(void *pvDisplayData, long lX1, long lX2,
...
//*****************************************************************************
static void
Formike128x128x16LineDrawV(void *pvDisplayData, long lX, long lY1,
			  ...
			  unsigned long ulValue)
{
    ...
    for (lCount = ((pRect->sXMax - pRect->sXMin + 1) *
		   (pRect->sYMax - pRect->sYMin + 1)); lCount > 0;
	 lCount--) {
	//
	// Write the pixel value.
	//
...
void vFormike128x128x16StringDraw(const char *pcString, unsigned long lX,
				  unsigned long lY, unsigned char ucColor)
{
    GrContextForegroundSet(&sContext, ClrWhite);
...
void vFormike128x128x16ImageDraw(const unsigned char *pucImage,
